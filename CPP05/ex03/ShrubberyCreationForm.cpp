...
{
	o << "Name: " << sh.getName() << std::endl;
    o << "Its signed: " << sh.getIsSigned() << std::endl;
    o << "Grade require to sign: " << sh.getGradeToSign() << std::endl;
    o << "Grade require to execute: " << sh.getGradeToExect() << std::endl;
	return (o);
}